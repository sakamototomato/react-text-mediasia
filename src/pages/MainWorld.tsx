...
function MainWorld() {
  ...
  useGetMinersQuery(undefined);
  useGetPlanetsQuery(undefined);
  ...
  return (
    <main>
      <div className="main-world">
        <div className="main-world-page">
          <div className="page-navigation">
            <div
              onClick={toggle("miners")}
              className={classNames("page-item miners", {
                active: tab === "miners",
              })}
            >
              <svg
            ...
            <div
              onClick={toggle("asteroids")}
              className={classNames("page-item asteroids", {
                active: tab === "asteroids",
              })}
            >
              <svg
                width="32"
